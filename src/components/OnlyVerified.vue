<template>
    <ion-modal
      mode="ios"
      :is-open="isOpen"
      :breakpoints="[0.25, 0.45, 0.5, 0.7, 0.8]"
      :initial-breakpoint="0.45"
      @didDismiss="close"
    >
      <ion-content>
        <div class="body">
          <div class="btit">Profil non vérifié</div>
          <div class="img_cont">
            <img :src="'../../imgs/heart.svg'" style="width: 60%" />
          </div>
          <div class="btext" >Pour plus de sécurité, {{ you?.prenom }} ne permet pas aux profils non vérifiés de lui écrire.</div>
          <button
