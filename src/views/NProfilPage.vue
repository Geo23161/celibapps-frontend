  ...
  <ion-page>
    <ion-content :scroll-y="true">
      <div class="bodyjj" id="rbody" v-if="has_load && visitor" style="width: 100%">
        ...
        <div style="position: fixed; z-index: -10;" :style="{
          width: '100%',
          height: '63vh',
        ...
        <div class="rbodyjj">
          <div class="present">
            ...
            <button @click="store_match({ pk: visitor.id, action: 'love' })" class="sound princ">
              <ion-icon style="position: relative; top: .2vh;" :icon="heart" />
            </button>
          </div>
          <div class="divid"></div>
          <div class="p_cont">
            ...
            <div class="photos">
              <div v-for="img in visitor.photos" :key="img.id" @click="click_img(img.id + ':img')" :style="{
                'background-size': 'cover',
                'background-position': 'top center',
      ...
      <div v-show="false">
        <photo-provider v-if="visitor">
          <photo-consumer v-for="img in visitor.photos" :key="img.id" :intro="'Lovelee'" :src="img.get_picture">
            <img :src="img.get_picture" :id="img.id + ':img'" style="width: 40vw:" class="view-box" />
          </photo-consumer>
        </photo-provider>
      </div>
    </ion-content>
