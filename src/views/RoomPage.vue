...
import { add, addCircle, arrowBack, camera, caretDown, filter, heart, help, information, mic, paperPlane, play, reload, trash, download, pause, caretUp, copy, close, chevronDown, checkmark, arrowForward, diamond } from "ionicons/icons";
...
const { user, storeFs, all_mess, charged_files, audios, launchers, l_accepted, l_refused, has_sen, state_obj, only_verified, day_discuss, day_mess } = userStore
